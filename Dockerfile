...
RUN mvn -f /opt/boxfuse/boxfuse-sample-java-war-hello/pom.xml
RUN cp /opt/boxfuse/boxfuse-sample-java-war-hello/target/hello-1.0.war /var/lib/tomcat9/webapps/
EXPOSE 8080